...
permalink: /compare/
description: <h1> My Attempts at competing against AI </h1> <br> <h2> The image juxtaposes my photography againt one generated by GPT-4 using a caption that GPT-4 itself generated, when prompted with my photography. <br> Click anywhere on the image to change the percentage of how much of each image is shown. Refresh the page for a new image pair. Current count - 14 Pairs</h2>
nav: true
nav_order: 8
---
